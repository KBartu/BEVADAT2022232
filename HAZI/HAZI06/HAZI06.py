...
"""
A feladat leírása alapján megcsináltam a .py fájlokat, HAZI06.ipynb-ben teszteltem, ahol a következő eredményeket is kaptam.
Sajnos a DecisionTree törlődött a gépemről, ezért azt a moodle-be feltöltött alapján újra létrehoztam, a Node-al együtt, majd megkapta a paramétereket.
Nehézségek:
    Figyelmetlenségből adódó hibák: rossz elnevezések, elírások, data mappa hiánya -> nem tudta elmenteni a NJ.csv-t
    A python néha szeret errort adni teljesen egyértelműen jó példákra.
Eredmények:
